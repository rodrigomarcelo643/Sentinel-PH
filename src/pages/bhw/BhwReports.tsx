...
import type { MapSymptomReport } from "@/@types/core";
...
export default function BhwReports() {
  ...
  const [selectedReport, setSelectedReport] = useState<MapSymptomReport | null>(
    null,
  );
  ...
  const [outbreakSeverity, setOutbreakSeverity] = useState<
    "low" | "medium" | "high"
  >("medium");
  ...
  const handleVerify = async (id: string) => {
    try {
      ...
      setReports(
        reports.map((r) => (r.id === id ? { ...r, status: "verified" } : r)),
      );
    ...
    try {
      ...
      const analysisData = reports
        ...
        .map((report) => ({
          ...
          residentId: report.userId || 'unknown',
        }));
      ...
      toast({
        ...
        variant:
          result.outbreakRisk === "HIGH" || result.outbreakRisk === "CRITICAL"
            ? "destructive"
            : "default",
      });
    } catch (error) {
    ...
    <div className="p-2 bg-gray-50 dark:bg-gray-900 min-h-screen">
      ...
      >
        ...
        <p className="text-gray-600 dark:text-gray-400">
          Review and manage community health reports
        </p>
      </motion.div>
          ...
          <table className="w-full min-w-37.5">
            <thead className="bg-gray-50 dark:bg-gray-900 border-b dark:border-gray-700">
              <tr>
                ...
                <th className="px-3 lg:px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider hidden sm:table-cell">
                  Type
                </th>
                <th className="px-3 lg:px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider">
                  Symptoms
                </th>
                <th className="px-3 lg:px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider hidden md:table-cell">
                  Location
                </th>
                <th
                  className="px-3 lg:px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider cursor-pointer hover:bg-gray-100 dark:hover:bg-gray-800"
                  ...
                  <td className="px-3 lg:px-6 py-4 whitespace-nowrap">
                    <div className="flex items-center gap-2 lg:gap-3">
                      ...
                      <div className="min-w-0 flex-1">
                        ...
                        <span className="text-xs text-gray-600 dark:text-gray-400 block truncate sm:hidden">
              ...
              <div className="border-t dark:border-gray-700 pt-4">
                ...
                <div className="flex items-start gap-2 text-sm text-gray-900 dark:text-white">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-gray-500 dark:text-gray-400 mt-1">
                      Coordinates: {selectedReport.latitude.toFixed(6)},{" "}
      ...
      >
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              Are you sure you want to verify this report from{" "}
      ...
      <AlertDialog
        open={isOutbreakDialogOpen}
        onOpenChange={setIsOutbreakDialogOpen}
      >
        <AlertDialogContent>
          <AlertDialogHeader>
            <AlertDialogTitle>Mark as Outbreak</AlertDialogTitle>
            <AlertDialogDescription>
              Mark this report from <strong>{selectedReport?.userName}</strong>{" "}
              as an outbreak alert.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <div className="py-4">
            <label className="text-sm font-medium text-gray-700 dark:text-gray-300 mb-2 block">
            ...
            <div className="space-y-2">
              <label className="flex items-center space-x-2">
                ...
                <span className="text-sm text-green-600 dark:text-green-400 font-medium">
                  LOW - Isolated case requiring monitoring
                </span>
              </label>
              <label className="flex items-center space-x-2">
                <input
                ...
                <span className="text-sm text-yellow-600 dark:text-yellow-400 font-medium">
                  MEDIUM - Potential outbreak requiring investigation
                </span>
              </label>
              <label className="flex items-center space-x-2">
                <input
                ...
                <span className="text-sm text-red-600 dark:text-red-400 font-medium">
                  HIGH - Confirmed outbreak requiring immediate response
                </span>
              </label>
            </div>
          </div>
          <AlertDialogFooter>
            <AlertDialogCancel onClick={() => setOutbreakSeverity("medium")}>
              Cancel
            </AlertDialogCancel>
            <AlertDialogAction
