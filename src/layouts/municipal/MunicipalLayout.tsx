...
import { LayoutDashboard, Users, MapPin, LogOut, ChevronDown, Settings, PanelLeftClose, PanelLeft, User } from "lucide-react";
    ...
    <>
      ...
      <div className="bg-white dark:bg-gray-800 px-3 py-4 flex-1 overflow-y-auto">
        <nav className="space-y-1">
          ...
          <NavLink to="/municipal/bhws" icon={Users} label="BHWs" onClick={() => setMobileOpen(false)} isDesktop={isDesktop} />
          <NavLink to="/municipal/map" icon={MapPin} label="Map" onClick={() => setMobileOpen(false)} isDesktop={isDesktop} />
          <NavLink to="/municipal/settings" icon={Settings} label="Settings" onClick={() => setMobileOpen(false)} isDesktop={isDesktop} />
        </nav>
      </div>
