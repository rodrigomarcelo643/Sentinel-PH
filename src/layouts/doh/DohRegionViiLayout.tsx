...
const BASE_PATH = "/doh-r7";

const NAV_CATEGORIES = [
  {
    title: "MAIN",
    items: [
      { to: `${BASE_PATH}/dashboard`, icon: LayoutDashboard, label: "Dashboard" },
      { to: `${BASE_PATH}/municipalities`, icon: Building, label: "Municipalities" },
      { to: `${BASE_PATH}/bhws`, icon: UserCog, label: "BHWs" },
      { to: `${BASE_PATH}/map`, icon: MapPinned, label: "Map View" },
    ],
  },
  {
    title: "MONITORING",
    items: [
      { to: `${BASE_PATH}/observations`, icon: Telescope, label: "Observations" },
      { to: `${BASE_PATH}/alerts`, icon: ShieldAlert, label: "Health Alerts" },
    ],
  },
];

export default function DohRegionViiLayout() {
  ...
  const [notifications, setNotifications] = useState<NavNotification[]>([
    {
      id: "1",
      type: "alert",
      title: "Regional Outbreak Alert",
      message: "Dengue cluster detected in Cebu City — 12 cases reported this week",
      timestamp: new Date(Date.now() - 1000 * 60 * 8),
      read: false,
      link: `${BASE_PATH}/alerts`,
    },
    {
      id: "2",
      type: "warning",
      title: "Municipality Report Pending",
      message: "Lapu-Lapu City has not submitted their weekly health report",
      timestamp: new Date(Date.now() - 1000 * 60 * 60 * 2),
      read: false,
      link: `${BASE_PATH}/municipalities`,
    },
    {
      id: "3",
      type: "success",
      title: "BHW Registration Approved",
      message: "15 new BHW accounts approved across Central Visayas",
    ...
    },
    {
      ...
      message: "DOH Region VII coordination meeting on June 5 at 10:00 AM",
    ...
    },
    {
      id: "5",
      type: "alert",
      title: "Observation Flagged",
      message: "Unusual symptom pattern flagged in Mandaue City observations",
      timestamp: new Date(Date.now() - 1000 * 60 * 60 * 24),
      read: true,
      link: `${BASE_PATH}/observations`,
    },
  ]);
  ...
  const displayName =
    user?.displayName || user?.fullName || user?.email?.split("@")[0] || "DOH Admin";
  const userRole = "DOH Region VII Administrator";
        ...
        <div className="border-t border-gray-200 dark:border-gray-700 p-2.5 bg-white dark:bg-gray-800">
          {isReallyCollapsed ? (
              ...
              <TooltipTrigger asChild>
                ...
                >
                  <Avatar className="h-8 w-8 rounded-[5px]">
                    <AvatarImage src={userAvatar} alt={displayName} className="rounded-[5px]" />
            ...
            <div className="relative" ref={menuRef}>
              ...
              >
                <Avatar className="h-8 w-8 ring-1 ring-gray-200 dark:ring-gray-600 rounded-[5px]">
                  <AvatarImage src={userAvatar} alt={displayName} className="rounded-[5px]" />
  ...
  return (
    <RegionScopeProvider
      value={{
        basePath: BASE_PATH,
        region: "Region VII",
        dashboardTitle: "DOH Region VII Dashboard",
        dashboardSubtitle:
          "Central Visayas health intelligence across municipalities",
      }}
    >
      <TooltipProvider>
        <div className="flex h-screen bg-gray-50 dark:bg-gray-900">
          {/* Desktop Sidebar */}
          <div
            className={`hidden lg:block relative transition-all duration-300 shrink-0 ${sidebarCollapsed ? "w-[4.5rem]" : "w-60"}`}
          >
            <aside
              ...
              <div className="flex items-center gap-1">
                ...
                <div className="relative">
                  <button
                    ...
                    className={`relative p-2.5 rounded-[5px] transition-all duration-200 ${
                      notifOpen
                    ...
                    <AnimatePresence>
                      {unreadCount > 0 && (
                        <motion.span
                          ...
                          animate={{ scale: 1 }}
                          exit={{ scale: 0 }}
                          className="absolute -top-0.5 -right-0.5 flex h-4.5 w-4.5 min-w-[18px] items-center justify-center rounded-[5px] bg-red-500 text-[9px] font-bold text-white ring-2 ring-white dark:ring-gray-800 px-1"
                        >
                        ...
                        >
                          <div className="flex items-center justify-between px-5 py-3.5 bg-gradient-to-r from-blue-600 to-indigo-600">
                            <div className="flex items-center gap-2">
                              ...
                              {unreadCount > 0 && (
                                <span className="inline-flex items-center justify-center h-5 min-w-5 px-1.5 rounded-[5px] bg-white/20 text-white text-[10px] font-bold">
                                  {unreadCount}
                                </span>
                              )}
                            </div>
                              ...
                              notifications.map((n, i) => {
                                ...
                                return (
                                  ...
                                  >
                                    {!n.read && (
                                      <span
                                        className={`absolute left-0 top-0 bottom-0 w-[3px] rounded-[5px] ${cfg.bar}`}
                                      />
                                    )}
                                    <div
                                      className={`shrink-0 h-8 w-8 rounded-[5px] flex items-center justify-center ${cfg.bg}`}
                                    >
                                    ...
                                    <div className="flex-1 min-w-0">
                                      <div className="flex items-start justify-between gap-1">
                                        ...
                                        {!n.read && (
                                          <span className="mt-1 h-2 w-2 rounded-[5px] bg-blue-500 shrink-0" />
                                        )}
                                      </div>
                ...
                <div className="relative">
                  ...
                  >
                    <Avatar className="h-8 w-8 ring-2 ring-gray-200 dark:ring-gray-600 rounded-[5px]">
                      <AvatarImage src={userAvatar} alt={displayName} className="rounded-[5px]" />
                      ...
                      <>
                        ...
                        >
                          <div className="flex items-center gap-3 px-4 py-4 bg-gradient-to-br from-slate-800 to-slate-900">
                            <Avatar className="h-11 w-11 ring-2 ring-white/20 rounded-[5px]">
                              <AvatarImage
                                src={userAvatar}
                                alt={displayName}
                            ...
                            <div className="min-w-0">
                              ...
                              <span className="inline-flex items-center mt-1 px-2 py-0.5 rounded-[5px] bg-blue-500/20 text-blue-300 text-[9px] font-semibold uppercase tracking-wider">
                                DOH R7
                              </span>
                            </div>
                          </div>
                          ...
                          <div className="p-1.5 space-y-0.5">
                            {[
                              ...
                              },
                              {
                                ...
                                ic: "text-gray-600 dark:text-gray-400",
                              },
                              ...
                              >
                                <div
                                  className={`h-8 w-8 rounded-[5px] flex items-center justify-center shrink-0 ${bg}`}
                                >
