  ...
  return (
    <div className="mb-6 flex items-center justify-between">
      ...
      <div className="relative group">
        ...
        <Button onClick={onStartScanning} className="relative bg-gradient-to-r rounded-[2px]! from-[#1B365D] to-[#2d4a7c] hover:from-[#152a4a] hover:to-[#1B365D] text-white px-6 py-6 cursor-pointer shadow-lg">
